...
// All rights reserved.
//------------------------------------------------------------------------------
// File name  : apb_uvc_master_agent.sv
...
class apb_uvc_master_agent extends uvm_agent;
  ...
  apb_uvc_master_driver m_driver;
...
// constructor
function apb_uvc_master_agent::new(string name, uvm_component parent);
...
function void apb_uvc_master_agent::build_phase(uvm_phase phase);
  ...
  if (m_cfg.m_is_active == UVM_ACTIVE) begin
    m_driver = apb_uvc_master_driver::type_id::create("m_driver", this);
...
// print configuration
function void apb_uvc_master_agent::print_cfg();
